...
def naiveBayes():
    ...
    for line in test_data :
        ...
        if(p_of_y2_line > p_of_y1_line):
            print("Predicted =",y2 + " Actual ="+line[-1] + " ",)
            print("Probablity =%.16f" % p_of_y2_line)
            if(y2 == line[-1]):
                correctClassified+=1
            else :
                incorrectlyClassified+=1
        else :
            print ("Predicted =",y1 + " Actual ="+line[-1] + " ",)
            print("Probablity =%.16f" % p_of_y1_line)
            if(y1 == line[-1]):
                correctClassified+=1
            else : 
                incorrectlyClassified+=1
    print ("")
    print (correctClassified,"correctly classified out of",correctClassified+incorrectlyClassified)
    print ("Naive bayes Accuracy =",correctClassified/(incorrectlyClassified+correctClassified)*100)
...
def tan():
    ...
    for line in test_data : 
        ...
        if(p_of_y1_x >=p_of_y2_x):
            print ("Predicted =",y1+" Actual ="+line[-1]+ " ",)
            print("Probablity =%.16f" % p_of_y1_x)
            if(y1==line[-1]):
                correctClassified+=1
            else : 
                incorrectlyClassified +=1
            ...
            print ("Predicted =",y2+" Actual ="+line[-1]+ " ",)
            print("Probablity =%.16f" % p_of_y2_x)
            if(y2==line[-1]):
                correctClassified+=1
            else : 
                incorrectlyClassified +=1
    print ("")
    print (correctClassified,"correctly classified out of",correctClassified+incorrectlyClassified)
    print ("TAN Accuracy =",correctClassified/(incorrectlyClassified+correctClassified)*100)
...
def main():
    global data
    global test_data
    # input of train,test,learning type from command line
    ...
    # redirecting according to input of learning type
    if(learningType == "n"):  
        naiveBayes()
    elif(learningType == "t"):
        tan()
